...
*PySpark · MLlib · PyTorch · Supabase · Next.js*
...
| ⚙️ `08_tel_preprocess.py` | Resample to (6, 1024), z-score → Telemetry Silver Parquet |
| 🏋️ `09_mae_pretrain.py` | MAE self-supervised pre-training (Colab-resumable, per-epoch checkpoint) |
...
<div align="center">
  <img src="assets/f1mae_diagram_dark.png" alt="MAE Architecture (Dark Mode)" width="80%">
</div>
...
4. **Optional: Override local data path:**
   ```bash
...
## 🛠️ Development Highlights & Resolutions
...
<div align="center">
  <br>
  <i>Built with passion for F1 and Data Engineering.</i>
</div>
